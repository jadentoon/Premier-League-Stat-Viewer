...
function Navbar({nav, handleNav}){
    ...
    return(
        <div className='flex justify-between items-center w-full py-[10px] px-[10%] fixed gap-[50px] bg-purple-300 drop-shadow-lg'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[40%] h-full border-r border-r-purple-900 bg-purple-950 ease-in-out duration-500' : 'fixed left-[-100%]'}>
